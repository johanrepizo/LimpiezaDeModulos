...
| `11` | `<div class="d-flex align-items-center justify-content-between flex-colum...` | Contenedor visual estructurado con Bootstrap/CSS: `<div class="d-flex align-items-center justify-content-between flex-colum...`. |
...
| `14` | `<strong style="color:#a8f090;">GestiLimpieza SENA</strong>.` | Instrucción de ejecución en el contexto del script: `<strong style="color:#a8f090;">GestiLimpieza SENA</strong>.`. |
...
| `18` | `<a href="#" style="font-size:.82rem; color:#5a8a50; text-decoration:none...` | Instrucción de ejecución en el contexto del script: `<a href="#" style="font-size:.82rem; color:#5a8a50; text-decoration:none...`. |
| `19` | `<a href="#" style="font-size:.82rem; color:#5a8a50; text-decoration:none...` | Instrucción de ejecución en el contexto del script: `<a href="#" style="font-size:.82rem; color:#5a8a50; text-decoration:none...`. |
| `20` | `<span style="font-size:.82rem; color:#5a8a50;">v1.0.0</span>` | Instrucción de ejecución en el contexto del script: `<span style="font-size:.82rem; color:#5a8a50;">v1.0.0</span>`. |
...
| `26` | `</div><!-- /mainContent -->` | Instrucción de ejecución en el contexto del script: `</div><!-- /mainContent -->`. |
| `27` | `</div><!-- /d-flex wrapper -->` | Instrucción de ejecución en el contexto del script: `</div><!-- /d-flex wrapper -->`. |
...
| `30` | `</body>` | Instrucción de ejecución en el contexto del script: `</body>`. |
| `31` | `</html>` | Instrucción de ejecución en el contexto del script: `</html>`. |
