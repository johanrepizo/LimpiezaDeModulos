...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-0"><i class="fas fa-bell text-success me-2"></i>Mis Notificaciones</h4>
        <p class="text-muted small mb-0">Alertas e incumplimientos de tu ficha</p>
    </div>
</div>
...
<ul class="nav nav-tabs mb-0">
    ...
    <li class="nav-item">
        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tabIncumplimientos">
            <i class="fas fa-triangle-exclamation me-1"></i>Incumplimientos (<?= count($incumplimientos) ?>)
        </button>
    </li>
</ul>
...
<div class="tab-content">
            ...
            <div class="card-body p-0">
                <?php if (empty($notificaciones)): ?>
                    <div class="text-center py-5 text-muted">
                        ...
                        <span class="small">No tienes notificaciones.</span>
                    </div>
                <?php else: ?>
    ...
    <!-- Incumplimientos -->
    <div class="tab-pane fade" id="tabIncumplimientos">
        <div class="card shadow-sm rounded-top-0">
            <div class="card-body p-0">
                <?php if (empty($incumplimientos)): ?>
                    <div class="text-center py-5 text-muted">
                        <i class="fas fa-check-circle text-success fa-2x mb-2 d-block"></i>
                        <span class="small">Sin incumplimientos registrados.</span>
                    </div>
                <?php else: ?>
                <div class="table-responsive">
                    <table class="table tabla-limpia align-middle mb-0">
                        ...
                        <tr>
                            ...
                            <td class="small text-muted"><?= htmlspecialchars($n['mensaje']) ?></td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
